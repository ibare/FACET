...
export const passTrackerView: View = {
  mount(container: HTMLElement, params: ViewMountParams): ViewInstance {
    ...
    root.style.padding = `${space.lg} ${space.md}`;
    ...
    tailLabel.style.whiteSpace = 'nowrap';
    ...
    barsBlock.style.alignItems = 'center';
    barsBlock.style.flex = '1';
    barsBlock.style.minWidth = '180px';
    ...
    barsLabel.style.whiteSpace = 'nowrap';
    barsLabel.style.textAlign = 'center';
    barsLabel.style.alignSelf = 'center';
    ...
    barsRow.style.alignSelf = 'stretch';
