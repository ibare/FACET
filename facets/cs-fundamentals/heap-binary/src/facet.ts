...
export const heapBinaryFacet: FacetJson = {
  ...
  description: {
    en: 'Think of it as a tree, keep it in an array — only the top is decided.',
    ko: '나무처럼 생각하고 배열에 담는다 — 정해진 것은 꼭대기뿐이다',
    ja: '木のように考え、配列に収める — 決まっているのは頂上だけ。',
    zh: '按树来想，用数组来存 — 确定的只有顶端。',
    ar: 'فكّر فيها كشجرة واحفظها في مصفوفة — المحدَّد هو القمة وحدها.',
    es: 'Piénsalo como un árbol y guárdalo en un arreglo: solo la cima está decidida.',
    fr: "Pensez-le comme un arbre, rangez-le dans un tableau — seul le sommet est fixé.",
    hi: 'सोचें पेड़ की तरह, रखें सरणी में — तय सिर्फ़ शीर्ष है।',
    id: 'Pikirkan sebagai pohon, simpan dalam larik — hanya puncaknya yang pasti.',
    pt: 'Pense como uma árvore, guarde num vetor — só o topo está definido.',
  },
